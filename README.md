...
### Smarty Minify 1.2 (сжатие и упаковка css js less). 
...
- combine=true - паковать все в один файл
- combine=false - не паковать
- minify=true - сжить код
- minify=false - не сжимать
...
- ***minify***  - если данный параметр установлен в trueто к данному ресурсу будет применятся сжатие. Если false - то файлы принадлежащие данному id не будут сжиматся. (по умолчанию: значение config.php)
