...
<head>
	...
	{* Стили *}
	<!-- render one css test -->
	{css id="style" include="design/{$settings->theme}/css/style.css" render=true}{/css}
	<!-- less test -->
	{css id="style_less" include="design/{$settings->theme}/css/style_less.less" less=true render=true}{/css}
	...
	{* JQuery *}
	<!-- jquery render test -->
	{js id="jquery" include="js/jquery/jquery.js"  render=true}{/js}
	...
	<!-- js add ctrlnavigate -->
	{js id="ctrlnavigate" include="js/ctrlnavigate.js"}{/js}    
	
	<!-- js add ajaxcart -->
	{* Аяксовая корзина *}
	{js id="ajaxcart" include=[
		"design/{$settings->theme}/js/jquery-ui.min.js",
		"design/{$settings->theme}/js/ajax_cart.js"
	]}{/js}

	<!-- js add baloons -->
	{* js-проверка форм *}
	{js id="baloon" include="js/baloon/js/baloon.js"}{/js}
	{css id="baloon" include="js/baloon/css/baloon.css"}{/css}
	
	{* Автозаполнитель поиска *}
	<!-- js add autocomplete include css code -->
	{js id="autocomplete" include="js/autocomplete/jquery.autocomplete-min.js"}
		$(function() {
			//  Автозаполнитель поиска
...
<body>
	...
	<!-- PRINT CSS -->
	{stylesheet combine=true minify=true}
	
	<!-- PRINT JS -->
	{javascript combine=true minify=true}
